...
This page preserves the research-level gate sequence. Concrete execution has moved to the sibling [delivery plan](../../plan/README.md), where each step is divided into a small artifact with dependencies and acceptance criteria.
