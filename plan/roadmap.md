...
D000 → D001 → D002 → D003 → D004 → D005 → D006
                  └─────────────→ D007 ─┐
                         ...
                         └→ D013 → D015  │
                                        ↓
D030 → D031 → D032/D033/D034/D035 → D036 → D040 → D041
                                                  ├→ D042
                                                  ├→ D043
                                                  ├→ D044–D048
                                                  ↓
...
The diagram is schematic: D007 requires D002 and D004; D008 requires D003 and D004; D009 requires D000, D007, and D008. No card may be declared complete before D000 exists, and no confirmatory run may begin before D009 is active.
